...
# basic conv for resnet
def conv3x3(inplanes, planes, stride=1):
    return nn.Conv2d(inplanes, planes, kernel_size=3, stride=stride, padding=1, bias=False)

def conv1x1(inplanes, planes, strdie=1):
    return nn.Conv2d(inplanes, planes, kernel_size=1, stride=strdie, bias=False)


# for resnet18 and smaller model than resnet59 
...
class ResNet(nn.Module):
    """
        ...
        Args:
            ...
            layers(lsit): Integer list for num of each layer
    """
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        """
            ...
            Args:
                block(class):type of Resblock
                layers(list):num of each layer   
        """
        downsample = None
